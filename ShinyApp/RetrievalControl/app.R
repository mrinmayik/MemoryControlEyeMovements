        ...
        tabItem(tabName = "background",
                fluidRow(
                  box(width = 6,
                      ...
                      p(HTML("But what happens to attention when you intentionally try to control the retrieval of that memory? Will the restaurant still draw your attention? Can you reduce the influence of that memory on your attention if you attempt to suppress it? Does your memory for that event get worse if you suppress it?"))
                  ), #Close goal box
                  box(width = 6,
                  ...
                  box(width = 6,
                      ...
                      p("In our study, we used eye-tracking to examine whether retrieval control affected eye-movements. This can tell us whether controlling our memory can change what we pay attention to."),
                      h4("Our Method"),
        ...
        tabItem(tabName = "study",
                ...
                fluidRow(
                  box(width = 12, #style = "background:black",
                      ...
                      p("In all, participants completed 216 trials that looked like this. In each trial, a scene was presented, and then a face or a tool was superimposed on top of the scene. Participants were instructuted to try to remember which scene went with which object (either face or tool)."),
                      img(src = "Encoding.gif", width = "25%", height = "25%", offset = 0, style='padding:0px;'),
                      br(),
                      br(),
                      h4("The Memory Control and Search Phase"),
                      p("In each trial in this phase, participants either retrieved information they had learned in the study phase, suppressed it, or substituted it with other learned information. After this, they performed a simple search task. During this phase, we tracked where on the screen participants were looking."),
                      ...
                      p("In this last phase, participants completed a surprise memory test. Here, in each trial they were presented with scenes they had learned during the study phase, and they had to choose the face or tool that had been paired with the scene."),
                  ...
                  box(width = 12,
                      ...
                      p("As a reminder, in this experiment, we were interested in studying if the attention drawn to the information retrieved from memory might be reduced if participants attempted to control the retrieval of that memory. To test if this was the case, we first examined how much they looked at the matching face that was embedded in the search display in Retrieve, Suppress and Substitute trials."),
                      ...
                      p("You can see in the retrieve condition (blue bar), when participants were instructed to call to mind the matching object, more eye movements were directed to the matching face relative to the Suppress (red) and substitute (yellow) conditions."),
